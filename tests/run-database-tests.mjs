...
for(const file of ['tests/database-regression.sql','tests/admin-workspace.sql','tests/admin-delete-confirmation.sql','tests/admin-permanent-delete.sql','tests/audit-financial-controls.sql']){
