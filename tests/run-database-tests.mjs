...
for(const file of ['tests/fee-version.sql','tests/database-regression.sql','tests/admin-workspace.sql','tests/admin-delete-confirmation.sql','tests/admin-permanent-delete.sql','tests/audit-financial-controls.sql']){
