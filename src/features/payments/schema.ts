...
export const verificationSchema = z.object({ membershipType:membershipTypeSchema.default("standard"), orderId: z.string().min(5).max(100), paymentId: z.string().min(5).max(100), signature: z.string().min(4).max(128) });
